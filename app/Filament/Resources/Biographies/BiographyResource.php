...
class BiographyResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Biografías';

    protected static ?string $pluralModelLabel = 'Biografías';

    protected static ?string $singularModelLabel = 'Biografía';
